...
<div class="flex mb-5">
   <section class="p-3 basis-2/3">
      <div class="bg-white dark:bg-slate-700 shadow-xl p-3 pb-7 rounded-xl relative overflow-hidden box-border">
         <div class="relative">
            <h3 class="p-4 pb-3 uppercase text-sm font-bold">Daftar Penerbit</h3>
            <p class="mb-6 text-sm px-4">Daftar penerbit pada perpustakaan</p>

            <button id="create" type="button" class="bg-violet-500 text-white px-4 py-2 rounded-lg shadow-lg text-xs absolute top-6 right-4 hover:bg-violet-600 active:bg-violet-700">Tambah Penerbit</button>
            ...
            <div class="flex items-center mb-5 px-4">
               <div class="relative w-full">
                  ...
                  <input type="text" id="search" class="border bg-transparent text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 block w-full pl-10 p-2.5 dark:border-slate-500" placeholder="Cari penerbit buku...">
               </div>
            </div>
...
$(document).ready(() => {
   ...
   function fetchData(page, search){
      $.ajax({
         url:"/penerbit/data?page="+page+"&search="+search,
