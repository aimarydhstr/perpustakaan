...
<div class="block mb-5">
   <section class="p-3">
      <div class="bg-white dark:bg-slate-700 shadow-xl p-3 pb-7 rounded-xl relative overflow-hidden box-border">
         <div class="relative">
            <h3 class="p-4 pb-3 uppercase text-sm font-bold">Pengembalian Buku</h3>
            <p class="mb-6 text-sm px-4">Pilihlah data peminjaman untuk mengembalikan buku</p>
         ...
         <div id="result">
            @include('pengembalian.data.index')
         </div>
...
$(document).ready(() => {
   ...
   function fetchData(page, search){
      $.ajax({
         url:"/pengembalian/data?page="+page+"&search="+search,
