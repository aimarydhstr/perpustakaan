         ...
         @foreach($borrows as $borrow)
            ...
            <tr class="bg-white border-b dark:bg-slate-700 dark:border-slate-600">
               ...
               <td class="py-4 text-center w-40">
                  <button type="button" id="create" data-id="{{ $borrow->id_peminjaman }}" class="bg-violet-500 text-white p-2 px-4 text-center rounded-full shadow-lg text-xs hover:bg-violet-700 active:bg-violet-800">Kembalikan Buku</button>
               </td>
            </tr>
...
<div id="createData">
   @include('pengembalian.data.create')
</div>
