   ...
   <section class="p-3">
      <div class="bg-white dark:bg-slate-700 shadow-xl pt-3 pb-7 rounded-xl relative overflow-hidden box-border">
         <div class="relative border-b dark:border-slate-600 px-7 flex items-center">
            ...
            <div class="ml-5">
               <h3 class="pt-4 pb-1 uppercase text-sm font-bold">Tambah Anggota Baru</h3>
               <p class="mb-6 text-sm">Tambah data anggota perpustakaan baru</p>
            </div>
         </div>
         ...
         <form method="post" action="{{ route('anggota.store') }}" class="flex p-7" enctype="multipart/form-data">
            @csrf
            <div class="w-64">
            ...
            <div class="pl-12 grow">
               <div>
                  ...
                  <input name="nama" id="nama" type="text" class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600" placeholder="Ketik nama anggota..." required autocomplete="off" autofocus>
               </div>
               <div class="pt-5">
                  <label for="email">Email anggota</label>
                  <input name="email" id="email" type="email" class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600" placeholder="Ketik email anggota..." required autocomplete="off">
               </div>
               <div class="pt-5">
               ...
               <div class="pt-5">
                  ...
                  <textarea name="alamat" id="alamat" type="text" class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600" placeholder="Ketik alamat anggota..." rows="4" required autocomplete="off"></textarea>
               </div>
               <div class="pt-3">
