         ...
         @foreach($members as $member)
            ...
            <tr class="bg-white border-b dark:bg-slate-700 dark:border-slate-600">
               ...
               <td class="py-4 w-40 text-center">
                  <button type="button" id="create" data-id="{{ $member->id_anggota }}" data-buku="{{ $book->id_buku }}" class="bg-violet-500 text-white p-2 px-4 text-center rounded-full shadow-lg text-xs hover:bg-violet-700 active:bg-violet-800">Pinjam Buku</button>
               </td>
            </tr>
...
<div id="createData">
   @include('peminjaman.data.create')
</div>
