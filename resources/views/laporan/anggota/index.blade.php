...
<div class="block mb-5">
   <section class="p-3">
      <div class="bg-white dark:bg-slate-700 shadow-xl p-3 pb-7 rounded-xl relative overflow-hidden box-border">
         <div class="relative">
            <h3 class="p-4 pb-3 uppercase text-sm font-bold">Laporan Data Anggota</h3>
            <p class="mb-6 text-sm px-4">Laporan data anggota perpustakaan</p>
         ...
         <div id="result">
            @include('laporan.anggota.data.index')
         </div>
...
$(document).ready(() => {
   ...
   function fetchData(page, search){
      $.ajax({
         url:"/laporan/anggota/data?page="+page+"&search="+search,
