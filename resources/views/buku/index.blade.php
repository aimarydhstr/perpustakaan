...
<div class="block mb-5">
   <section class="p-3">
      <div class="bg-white dark:bg-slate-700 shadow-xl p-3 pb-7 rounded-xl relative overflow-hidden box-border">
         <div class="relative">
            <h3 class="p-4 pb-3 uppercase text-sm font-bold">Daftar Buku</h3>
            <p class="mb-6 text-sm px-4">Daftar buku pada perpustakaan</p>

            <a href="{{ route('buku.create') }}" class="bg-violet-500 text-white px-4 py-2 rounded-lg shadow-lg text-xs absolute top-6 right-4 hover:bg-violet-600 active:bg-violet-700">Tambah Buku</a>
            ...
            <div class="flex items-center mb-5 px-4">
               <div class="relative w-full">
                  ...
                  <input type="text" name="search" id="search" class="border bg-transparent text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 block w-full pl-10 p-2.5 dark:border-slate-500" placeholder="Cari judul buku..." autofocus autocomplete="off">
               </div>
            </div>
...
$(document).ready(() => {
   ...
   function fetchData(page, search){
      $.ajax({
         url:"/buku/data?page="+page+"&search="+search,
